...
// O site buscará: /gallery-1.jpg até /gallery-5.jpg na pasta public.
const INITIAL_IMAGES = [
  ...
  { src: "/gallery-5.jpg", fallback: "https://images.unsplash.com/photo-1466692476868-aef1dfb1e735?w=600&q=80" } // Nova imagem
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
          <div>
            ...
            <div className="h-1 w-20 bg-hi-vis-orange mt-4 rounded-full"></div>
          </div>
          <p className="text-gray-400 max-w-md text-sm md:text-right leading-relaxed">
            Veja a complexidade e a limpeza das nossas operações. Cada projeto é executado com precisão cirúrgica e respeito ao seu patrimônio.
          </p>
        </div>
          ...
          {images.map((img, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                <span className="font-bold text-white tracking-wide">Operação #{index + 1}</span>
              </div>
            </div>
          ))}
        </div>
